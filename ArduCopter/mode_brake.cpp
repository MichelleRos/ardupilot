...
bool ModeBrake::init(bool ignore_checks)
{
    ...
    pos_control->set_max_speed_accel_xy(copter.vel_neu.length(), BRAKE_MODE_DECEL_RATE);
    pos_control->set_correction_speed_accel_xy(copter.vel_neu.length(), BRAKE_MODE_DECEL_RATE);
