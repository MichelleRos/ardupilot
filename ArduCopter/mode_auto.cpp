...
void ModeAuto::nav_attitude_time_run()
{
    ...
    const float angle_limit_cd = MAX(1000.0f, MIN(copter.aparm.angle_max_deg*100.0, attitude_control->get_althold_lean_angle_max_cd()));
...
void PayloadPlace::run()
{
    ...
    case State::Descent_Start:
        ...
        descent_speed_cms = MIN((is_positive(g2.pldp_descent_speed_ms)) ? g2.pldp_descent_speed_ms * 100.0 : abs(g.land_speed_fin/100), wp_nav->get_default_speed_down());
