...
void ModeGuided::limit_init_time_and_pos()
{
    ...
    guided_limit.start_pos = copter.pos_neu;
}
...
uint32_t ModeGuided::wp_distance() const
{
    ...
    case SubMode::Pos:
        return norm(guided_pos_target_cm.x - copter.pos_neu.x, guided_pos_target_cm.y - copter.pos_neu.y);
    case SubMode::PosVelAccel:
...
int32_t ModeGuided::wp_bearing() const
{
    ...
    case SubMode::Pos:
        return get_bearing_cd(copter.pos_neu, guided_pos_target_cm.tofloat());
    case SubMode::PosVelAccel:
